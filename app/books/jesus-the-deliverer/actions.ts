...
export async function requestBookDownload(formData: FormData) {
  try {
    ...
    const bookResult = await resend.emails.send({
      ...
      to: [email],
      subject: "Your Free Copy of Jesus the Deliverer",
      html: `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="padding: 30px; background: #ffffff;">
        <h2 style="color: #0F3543; margin-bottom: 20px;">Thank you for your interest in "Jesus the Deliverer"</h2>
        
        <p style="color: #333; line-height: 1.6; margin-bottom: 20px;">
          I'm excited to share this book with you! "Jesus the Deliverer" explores the biblical foundations of deliverance ministry and how we can reclaim this vital aspect of Christ's work in the church today.
        </p>
        
        <div style="text-align: center; margin: 30px 0; padding: 20px; background: #f8f9fa; border-radius: 8px;">
          <h3 style="color: #0F3543; margin-top: 0; margin-bottom: 15px;">📖 Download Your Free Book</h3>
          <a href="${baseUrl}/books/jesus-the-deliverer.pdf" 
             ...
             download="Jesus-the-Deliverer.pdf">
            📥 Download PDF Now
          </a>
        ...
        <div style="background: #e8f4f8; padding: 15px; border-radius: 5px; margin: 20px 0;">
          ...
          <p style="color: #333; margin: 0; font-size: 14px;">
            • <a href="${baseUrl}/books/jesus-the-deliverer.pdf" style="color: #0F3543; text-decoration: underline;" download="Jesus-the-Deliverer.pdf">Direct download link</a><br>
  ...
  `,
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <p>Someone has requested a copy of "Jesus the Deliverer":</p>
    ...
    return {
      success: true,
      message: "Thank you! Check your email for your free copy of 'Jesus the Deliverer'.",
    }
  } catch (error) {
